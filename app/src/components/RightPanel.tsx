        ...
        {storyHistory.map((entry, i) => {
          ...
          return (
            <motion.div
              ...
              className="mb-3 p-3 bg-[var(--panel)] rounded-lg border border-[var(--border)] hover:border-[var(--accent)] transition-colors cursor-pointer"
            ...
            >
              ...
              <div className="flex gap-2 mt-2">
                <button className="text-[10px] px-2 py-1 bg-[var(--success)]/20 text-[var(--success)] rounded hover:bg-[var(--success)] hover:text-white transition-all flex items-center gap-1">
...
function CharacterDetail({ character, onUpdate, onDelete, onBack, onClose }: {
  ...
  const fields = [
    ...
    { key: 'goals' as const, label: 'Goals', icon: Target, placeholder: 'What do they want?', type: 'textarea' },
